    ...
    methods:{
        ...
        async sendtoix(){
          var data = JSON.stringify({
            ...
            var config = {
              method: 'POST',
              url: 'https://api.secondhandcars.co.za/forms/ixtest.php',
              headers: { 
                'Content-Type': 'application/json'
              },
              data : data
          ...
          this.facebookevent(this.formdata.firstName, this.formdata.lastName, this.formdata.emailAddress, this.formdata.contactNumber)
            ...
            // var config = {
            //   method: 'post',
            //   url: 'https://1wk2xps2l4.execute-api.eu-west-1.amazonaws.com/default/SecondHandCarsAPI/IXInsert',
            //   headers: { 
            //     'Content-Type': 'application/json'
            //   },
            //   data : data
        ...
        async facebookevent(firstname, lastname, email, number) {
